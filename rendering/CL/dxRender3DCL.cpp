...
void rendering::DXRender3DCL::InitProperties(interpreter::NativeObject & nativeObject)
{
...
bool rendering::DXRender3DCL::Create(
    ID3D12Device* device,
...
bool rendering::DXRender3DCL::Populate(
...
bool rendering::DXRender3DCL::Execute(ID3D12CommandQueue* commandQueue, ID3D12Fence* fence, int signal, std::string& error)
{
