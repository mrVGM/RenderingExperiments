...
void rendering::noise::DXCanvasMatCL::InitProperties(interpreter::NativeObject & nativeObject)
{
...
return Value();
    ...
    create = CreateNativeMethod(nativeObject, 3, [](Value scope) {
        ...
        DXCanvasMatCL* self = static_cast<DXCanvasMatCL*>(NativeObject::ExtractNativeObject(selfValue));
...
bool rendering::noise::DXCanvasMatCL::Create(
    ID3D12Device* device,
...
bool rendering::noise::DXCanvasMatCL::Populate(
...
bool rendering::noise::DXCanvasMatCL::Execute(ID3D12CommandQueue* commandQueue, ID3D12Fence* fence, int signal, std::string& error)
{
...
bool rendering::noise::DXCanvasMatCL::ExecuteAsync(ID3D12CommandQueue* commandQueue, std::string& error)
{
    ID3D12CommandList* ppCommandLists[] = { m_commandList.Get() };
    commandQueue->ExecuteCommandLists(_countof(ppCommandLists), ppCommandLists);
