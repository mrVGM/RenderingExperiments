...
void rendering::DXUnlitMatCL::InitProperties(interpreter::NativeObject & nativeObject)
{
...
bool rendering::DXUnlitMatCL::Create(
    ID3D12Device* device,
...
bool rendering::DXUnlitMatCL::Populate(
...
bool rendering::DXUnlitMatCL::Execute(ID3D12CommandQueue* commandQueue, ID3D12Fence* fence, int signal, std::string& error)
{
...
bool rendering::DXUnlitMatCL::ExecuteAsync(ID3D12CommandQueue* commandQueue, std::string& error)
{
    ID3D12CommandList* ppCommandLists[] = { m_commandList.Get() };
    commandQueue->ExecuteCommandLists(_countof(ppCommandLists), ppCommandLists);
