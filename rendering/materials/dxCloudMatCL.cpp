...
void rendering::DXCloudMatCL::InitProperties(interpreter::NativeObject & nativeObject)
{
...
bool rendering::DXCloudMatCL::Create(
    ID3D12Device* device,
...
bool rendering::DXCloudMatCL::Populate(
...
bool rendering::DXCloudMatCL::Execute(ID3D12CommandQueue* commandQueue, ID3D12Fence* fence, int signal, std::string& error)
{
