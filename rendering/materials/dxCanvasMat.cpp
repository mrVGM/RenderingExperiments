...
void rendering::material::DXCanvasMat::InitProperties(interpreter::NativeObject & nativeObject)
{
...
rendering::material::MaterialType rendering::material::DXCanvasMat::GetMaterialType() const
{
    return rendering::material::MaterialType::Canvas;
}

bool rendering::material::DXCanvasMat::Render(
...
bool rendering::material::DXCanvasMat::Init(DXRenderer& renderer, std::string& errorMessage)
{
