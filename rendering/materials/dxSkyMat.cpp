...
void rendering::material::DXSkyMat::InitProperties(interpreter::NativeObject & nativeObject)
{
...
return Value();
    ...
    setConstantBuff = CreateNativeMethod(nativeObject, 1, [&](Value scope) {
        ...
        DXSkyMat* self = static_cast<DXSkyMat*>(NativeObject::ExtractNativeObject(selfValue));
...
rendering::material::MaterialType rendering::material::DXSkyMat::GetMaterialType() const
{
    return rendering::material::MaterialType::Sky;
}

bool rendering::material::DXSkyMat::Render(
...
bool rendering::material::DXSkyMat::Init(DXRenderer& renderer, std::string& errorMessage)
{
