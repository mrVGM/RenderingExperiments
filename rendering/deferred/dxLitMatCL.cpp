...
void rendering::DXLitMatCL::InitProperties(interpreter::NativeObject & nativeObject)
{
...
bool rendering::DXLitMatCL::Create(
    ID3D12Device* device,
...
bool rendering::DXLitMatCL::Populate(
...
bool rendering::DXLitMatCL::Execute(ID3D12CommandQueue* commandQueue, ID3D12Fence* fence, int signal, std::string& error)
{
...
bool rendering::DXLitMatCL::ExecuteAsync(ID3D12CommandQueue* commandQueue, std::string& error)
{
    ID3D12CommandList* ppCommandLists[] = { m_commandList.Get() };
    commandQueue->ExecuteCommandLists(_countof(ppCommandLists), ppCommandLists);
