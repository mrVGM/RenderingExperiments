...
void rendering::clouds::DXCloudsCamera::InitProperties(interpreter::NativeObject & nativeObject)
{
...
return Value();
	...
	setPosition = CreateNativeMethod(nativeObject, 1, [](Value scope) {
		...
		DXCloudsCamera* self = static_cast<DXCloudsCamera*>(NativeObject::ExtractNativeObject(selfValue));
...
DirectX::XMMATRIX rendering::clouds::DXCloudsCamera::GetMVPMatrix() const
{
...
DirectX::XMVECTOR rendering::clouds::DXCloudsCamera::GetForwardVector() const
{
...
void rendering::clouds::DXCloudsCamera::HandleInput(double dt, std::list<WPARAM>& keysDown, std::list<WPARAM>& keysUp)
{
